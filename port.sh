...
#qi1=`su elk -c 'nohup /opt/elasticsearch-5.5.2/bin/elasticsearch &'`
#qi2=`nohup /opt/logstash-5.5.2/bin/logstash -f /opt/logstash-5.5.2/config/nginx.yml &`
#qi3=`/opt/kibana-5.5.2-linux-x86_64/bin/kibana &`
